...
ING_RU = {
    ...
    'macaroni': 'макароны', 'rigatoni': 'ригатони', 'penne': 'пенне', 'fettuccine': 'феттучине',
    'lasagna noodles': 'лапша для лазаньи',
    'parmesan cheese': 'пармезан', 'mozzarella cheese': 'моцарелла',
    'italian bread': 'итальянский хлеб', 'french bread': 'французский хлеб',
    'white bread': 'белый хлеб', 'wheat bread': 'пшеничный хлеб',
    'corn tortilla': 'кукурузная тортилья', 'flour tortilla': 'мучная тортилья',
    'ground lean pork': 'постный свиной фарш', 'lean ground pork': 'постный свиной фарш',
    'lean pork': 'постная свинина', 'ground lean beef': 'постный говяжий фарш',
    'rice wine vinegar': 'рисовый уксус', 'seasoning mix': 'смесь приправ',
    'generous': 'щедрая порция',
    ...
    'marmalade': 'варенье', 'orange marmalade': 'апельсиновое варенье',
    ...
    'sherry': 'херес', 'dry sherry': 'сухой херес', 'sherry cream': 'сливки с хересом',
    'whipping cream sherry': 'сливки с хересом',
    'dry wine': 'сухое вино',
    ...
    'cranberries': 'клюква', 'cranberry': 'клюква', 'dried cranberries': 'сушёная клюква',
    'blueberry': 'черника',
    'marjoram': 'майоран', 'dried marjoram': 'сушёный майоран',
    ...
    'borlotti': 'борлотти', 'borlotti beans': 'фасоль борлотти', 'borlotti bean': 'фасоль борлотти',
